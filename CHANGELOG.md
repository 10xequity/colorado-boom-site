...
- Owner: hero "too close and pixelated". Two causes. The file was 1800px wide, so large and
  ...
  height at common widths (was ~60%). Text block anchored to the bottom of the band (where the overlay is darkest) so the headline no longer covers the central face; photo positioned `center 25%` to keep faces in the upper part.
